...
export class AppComponent {
  ...
  ngOnInit() {
    ...
    this.metaService.addTags([
      ...
      {
        name: 'description', content: `sentence converter is an online text and word processing utility it’s helps to you to allow any text you would like to select and transforming into fully structured sentence.` },
