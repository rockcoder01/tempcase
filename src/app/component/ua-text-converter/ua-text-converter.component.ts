...
@Component({
  selector: 'app-ua-text-converter',
  templateUrl: './ua-text-converter.component.html',
  styleUrls: ['./ua-text-converter.component.scss']
})
export class UaTextConverterComponent implements OnInit {
