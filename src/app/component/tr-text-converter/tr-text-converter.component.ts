...
@Component({
  selector: 'app-tr-text-converter',
  templateUrl: './tr-text-converter.component.html',
  styleUrls: ['./tr-text-converter.component.scss']
})
export class TrTextConverterComponent implements OnInit {
