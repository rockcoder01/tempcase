...
@Component({
  selector: 'app-fr-text-converter',
  templateUrl: './fr-text-converter.component.html',
  styleUrls: ['./fr-text-converter.component.scss']
})
export class FrTextConverterComponent implements OnInit {
