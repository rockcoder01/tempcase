...
@Component({
  selector: 'app-pl-text-converter',
  templateUrl: './pl-text-converter.component.html',
  styleUrls: ['./pl-text-converter.component.scss']
})
export class PlTextConverterComponent implements OnInit {
